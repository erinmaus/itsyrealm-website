...
def add_release():
	...
	if form.validate_on_submit():
		...
		return redirect(url_for("admin.downloads.edit_release",release_id=release.id))
...
def add_download(release_id):
	...
	if form.validate_on_submit():
		if not form.binary.data:
			...
			return redirect(url_for("admin.downloads.edit_release", release_id=release_id))
...
def delete_download(download_id):
	...
	if download:
		return redirect(url_for("admin.releases.edit_release", release_id=download_id.release_id))
	else:
		return redirect(url_for("admin.downloads.index"))
